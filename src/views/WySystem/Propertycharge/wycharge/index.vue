<template>
  <div class="hard-setparamClass">
    <div class="setparam-container">
      <el-card class="box-card">
        <div class="kuang">
          <span>
            ...
            <el-button v-if="shoufeizhans" class="newadds" type="text" @click="clearss">返回上一级</el-button>
          </span>
          <span>
            <input
              v-if="!back&&!shoufeizhans"
          ...
          <span class="btn" @click="search" v-if="!back&&!shoufeizhans">
            <svg-icon icon-class="search1" />
          </span>
        </div>
        <el-table :data="tableData" style="width: 100%" empty-text="暂无数据" v-if="!shoufeizhans">
          ...
          <el-table-column prop="tingche" label="车位管理费欠费金额（元）" width="250" />
          <el-table-column prop="shenghuo" label="其他项目欠费金额（元）" width="280" class="remark" />
          <el-table-column label="操作" width="190">
            <template slot-scope="scope">
              <el-button v-if="!caozuo" class="el-btn44" type="text" @click="shoufei(scope.row)">收费</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="shoufeikuang" v-if="shoufeizhans">
          <div class="one">
            <div class="one_1">
              <div class="one__1">
                <div class="one-lyl">房屋信息</div>
                <div class="one-dcp">
                  <div class="one__2">
                    <span>押金账单</span>
                  </div>
            ...
            <div class="two_1">
              ...
              <div class="two__2">
                ...
                <div class="dcp_two_2">
                  ...
                  <span class="two">2019-06-23至2019-10-23（共欠费4个月）</span>
                </div>
                <div class="dcp_two_3">
      ...
      <!-- 分页 -->
      <div class="block" v-show="!searchs&&!shoufeizhans">
...
export default {
  ...
  methods: {
      ...
      if (this.searchForm.orderNo) {
        ...
        data.data.forEach(v => {
          if (v.star_time === 0) {
            ...
            v.star_time = moment(v.star_time * 1000).format(
              "YYYY-MM-DD HH:mm:ss"
            );
          }
    ...
    async parkList() {
      ...
      this.totalPage = data.msg.total; // 总条数
      this.pageNums = data.msg.pageNum; // 总页数
      // console.log(data);
    },
    //秒换算成小时
    formatSeconds(value) {
