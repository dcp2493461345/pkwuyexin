        ...
        <div class="form-item" style="height: 60px;">
          <el-form-item label="职位:" class="zhiwei">
            <input
              ...
              type="text"
              style="width:100%; border:1px solid rgba(210,210,210,1);height:32px; border-radius:4px; color:#333;"
...
import { postSelect_button, postSelect_list, postSelect_jurisdiction, postSelect_add, postSelect_add_list, postDelete_list, postUpdete_add_list, postUpdete_list, postToexamine_list } from '@/api/Jurisdiction1'
export default {
  components: {},
  //data数据
  data () {
    return {
      ...
      loadingTree: false,//创建树加载
      loadingTree1: false,//创建树加载
