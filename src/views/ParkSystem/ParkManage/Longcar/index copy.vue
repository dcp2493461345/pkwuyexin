<template>
  <div class="hard-setparamClass">
    <div class="setparam-container">
      <span @click="Eclipse" class="download" v-if="!isShowExcel">下载长租车模板</span>
      ...
      <el-card class="box-card" v-if="!isShowExcel">
        ...
        <el-table
         ...
         >
          ...
          <el-table-column prop="car_position" label="车位号（ — 已到期  — 快到期 ）" min-width="260">
            <template slot-scope="scope">
        ...
        <el-table
          ...
          class="table_FOUR"
         >
          <el-table-column prop="car_type" label="车位号" width="300"></el-table-column>
          ...
          <el-table-column prop="price" label="收费金额（元）" width="300">
            <template slot-scope="scope">
              <span class="svg_tubiao" v-if="scope.row.price_type===1">
                <svg-icon icon-class="weixin" />
              </span>
              <span class="svg_tubiao" v-if="scope.row.price_type===2">
                <svg-icon icon-class="zhifubao" />
              </span>
              <span class="svg_tubiao" v-if="scope.row.price_type===3">
                <svg-icon icon-class="xianjin" />
              </span>
              <span class="svg_tubiao" v-if="scope.row.price_type===4">
          ...
          <el-table-column prop="price" label="余额（元）" width="300"></el-table-column>
      ...
      <div v-if="isShowExcel" class="table-box-one">
        <div class="table-box">
          ...
          >
            ...
            <el-table-column prop="car_type" label="车位号" min-width="300">
              <template slot-scope="scope">
                <div>
                  <p
                    v-for="(itme,index) in scope.row.type_all"
                    :key="index"
                  >{{itme}}（开始时间：{{scope.row.start_time}}；长租时长：{{scope.row.moth}}个月）</p>
                </div>
        ...
        <div v-for="(item,index) in dynamicValidateForm" :key="index" class="my-form-item">
          <div :class="isshow(index)">
            <div class="main-inp">
              ...
              <input v-model="item.num" class="input_one" />
            ...
            <div class="main-inp">
              ...
              <el-radio-group v-model="item.raido">
            ...
            <div class="main-inp" v-if="item.raido==='2'">
              <el-checkbox-group v-model="item.type">
                <el-checkbox label="1" name="type">一号门岗地上</el-checkbox>
                <el-checkbox label="2" name="type">二号门岗地上</el-checkbox>
                <el-checkbox label="3" name="type">三号门岗地上</el-checkbox>
                <el-checkbox label="4" name="type">四号门岗地上</el-checkbox>
              </el-checkbox-group>
            </div>
        ...
        <div v-for="(item,index) in bindparking" :key="index+10" class="my-form-item">
          <div :class="isshows(index)">
            <div class="main-inp">
              ...
              <!-- <input v-model="item.carport" @input="changcar(index)" /> -->
            ...
            <div class="main-inp">
              ...
              <input @change="changejine"    onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''" v-model="item.shouldbe" placeholder="选填" />
      ...
      <div class="box-fold">
        ...
        <div v-for="(item,index) in xufeuFrom1" :key="index" class="my-form-item">
          <div :class="isshow1(index)">
            <div class="main-inp">
              <span class="label-name">车牌号{{index+1}}：</span>
              <input v-model="item.car_number" class="input_one" />
            ...
            <div class="main-inp">
              <span class="label-name1">是否指定进出口：</span>
              <el-radio-group v-model="item.car_into">
                <el-radio :label="2">是</el-radio>
                <el-radio :label="1">否</el-radio>
              </el-radio-group>
            </div>
        ...
        <div v-for="(item,index) in xufeiFrom2" :key="index+10" class="my-form-item">
          <div :class="isshows1(index)">
            <div class="main-inp">
              <span class="label-name">车位号{{index+1}}：</span>
              <input v-model="item.car_type" @input="changcar1(index)" :disabled="index<=isjiebang" />
     ...
     >
      ...
      >
        ...
        <div class="yanzhengss">
          <div v-show="tuikuan">退租时长不能为空</div>
        </div>
        ...
        <div class="yanzhengss">
          <div v-show="tuikuan1">退款金额不能为空</div>
        </div>
        ...
        <el-form-item label="退款理由:" class="input_two">
          ...
          <div class="yanzhengss1">
            <div v-show="tuikuan2">退款理由不能为空</div>
          </div>
        </el-form-item>
      </el-form>
      <div class="footer-class">
...
export default {
  ...
  async created () {
    ...
    const obj = await longcarcheweihao({
      parkid:this.parkid,
      name:"a"
    })
    console.log(obj,"车位号");
    for(var i in obj.data){
      this.states.push(obj.data[i].car_number)
    }
         console.log(this.states,"车位号");
  },
     mounted() {
  ...
  methods: {
      ...
      for (var i = 0; i < this.xufeuFrom1.length; i++) {
        for (var j = 0; j < this.xufeiFrom2.length; j++) {
          if (this.xufeuFrom1.length == 1 && this.xufeiFrom2.length == 1) {
            ...
            if (!this.xufeuFrom1[this.cindex].car_number) {
              this.vtrenew = false;
              this.Bindandvntrew = true;
            }
            if (this.xufeuFrom1[this.cindex].car_number) {
              if (!carNumberReg.test(this.xufeuFrom1[this.cindex].car_number)) {
                this.index2 = this.cindex;
                this.showsss = true;
                setTimeout(() => {
                  this.index2 = null;
                  this.showsss = false;
            ...
            if (!this.xufeuFrom1[i].car_number) {
              ...
              if (!carNumberReg.test(this.xufeuFrom1[i].car_number)) {
              ...
              } else if (!this.xufeiFrom2[this.cindex1].car_type && this.xufeiFrom2[this.key].moth) {
                this.vtrenew = false;
                this.Bindandvntrew = true;
              } else if (!this.xufeiFrom2[this.cindex1].car_type && !this.xufeiFrom2[this.key].moth) {
                this.shows5 = true;
              ...
              else if (this.xufeiFrom2[this.cindex1].car_type && !this.xufeiFrom2[this.cindex1].moth) {
                this.shows5 = true;
                ...
                longcarcw({
                  name: this.xufeiFrom2[this.cindex1].car_type,
                  parkid: this.parkid
                }).then(res => {
                  // console.log(res);
                  if (res.data === "没有当前车位不允许添加") {
                    this.shows7 = true;
                    this.index3 = this.cindex1;
                    setTimeout(() => {
                      this.shows7 = false;
                      this.index3 = null;
                    }, 2000);
            ...
            if (!this.xufeuFrom1[this.cindex].car_number && !this.xufeiFrom2[this.cindex1].car_type) {
              this.vtrenew = false;
              this.Bindandvntrew = true;
            } else if (this.xufeuFrom1[this.cindex].car_number && !this.xufeiFrom2[this.cindex1].car_type) {
              if (!carNumberReg.test(this.xufeuFrom1[this.cindex].car_number)) {
                this.index2 = this.cindex;
                this.showsss = true;
                setTimeout(() => {
              ...
              } else if (!this.xufeiFrom2[this.cindex1].moth) {
                this.shows5 = true;
                this.index4 = this.cindex1;
                setTimeout(() => {
                  this.shows5 = false;
    ...
    uniform () {
      ...
      this.xufeiFrom2.forEach(v => {
        v.moth = Number(v.moth) + Number(this.renewal);
    ...
    async minitabtwo () {
      ...
      this.bindparking.forEach(v => {
        if (v.carport) {
          this.AddFrom.car_position += v.carport + ",";
        }
              ...
              for (var j = 0; j < this.bindparking.length; j++) {
                if (this.bindparking.length == 1) {
                  if (!this.bindparking[j].carport) {
                    ...
                    longcarcw({
                      name: this.bindparking[j].carport,
                      parkid: this.parkid
                    }).then(res => {
                      // console.log(res);
                      if (res.data === "没有当前车位不允许添加") {
    ...
    async changcar (index) {
      ...
      let data = await longcarcw({
        name: this.bindparking[index].carport,
        parkid: this.parkid
      });
      ...
      } else if (data.data.car_number_state === 2) {
        this.shows7 = false;
        this.shows6 = true;
        this.index3 = index;
        setTimeout(() => {
      ...
      } else if (data.data.car_number_state === 1) {
        this.shows6 = false;
        this.shows7 = false;
      }
    },
    async changcar1 (index) {
      ...
      let data = await longcarcw({
        name: this.xufeiFrom2[index].car_type,
        parkid: this.parkid
      });
      // console.log(data, "8988888888888888");
    ...
    changeNumber () {
      this.bindparking.forEach(v => {
          ...
          //  v.shouldbe = v.longduration * Number(v.price_dan) || 0;
        ...
        .then(res => {
          ...
          if (res.data.msg === 1) {
            ...
            res.data.data.msg.forEach(v => {
              v.start_time = moment(v.start_time * 1000).format('YYYY-MM-DD HH:mm:ss')
            })
