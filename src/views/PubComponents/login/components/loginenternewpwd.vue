...
import { postUpdete, postPosition, postCommunity } from '@/api/user'
...
export default {
  ...
  created () {
    // 查询字符串， query‘
    // console.log(this.uid, 'uiduiduid')
  },
  methods: {
    ...mapMutations(['setUserInfo', 'setDueToTheTime', 'amgHandler', 'uidHandler']),
    ...mapActions(['enterPwd']),
    showPwd () {
